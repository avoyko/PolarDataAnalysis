...
class Accumulator {
 public:
  FIT_UINT32 Accumulate(const FIT_UINT16 mesgNum, const FIT_UINT8 destFieldNum,
                        const FIT_UINT32 value, const FIT_UINT8 bits);
  void Set(const FIT_UINT16 mesgNum, const FIT_UINT8 destFieldNum,
