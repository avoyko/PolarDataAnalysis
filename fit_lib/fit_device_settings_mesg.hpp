...
class DeviceSettingsMesg : public Mesg {
 public:
  ...
  // Comment: Offset from system time. Required to convert timestamp from system
  // time to UTC.
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetTimeZoneOffset(FIT_UINT8 index, FIT_FLOAT32 timeZoneOffset) {
    SetFieldFLOAT32Value(5, timeZoneOffset, index,
  ...
  void SetActivityTrackerEnabled(FIT_BOOL activityTrackerEnabled) {
    SetFieldENUMValue(36, activityTrackerEnabled, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: Enable auto-detect setting for the lactate threshold feature.
  ///////////////////////////////////////////////////////////////////////
  void SetLactateThresholdAutodetectEnabled(
      FIT_BOOL lactateThresholdAutodetectEnabled) {
    SetFieldENUMValue(80, lactateThresholdAutodetectEnabled, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetBleAutoUploadEnabled(FIT_BOOL bleAutoUploadEnabled) {
    SetFieldENUMValue(86, bleAutoUploadEnabled, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: Allows setting specific activities auto-activity detect
  ...
  void SetAutoActivityDetect(FIT_AUTO_ACTIVITY_DETECT autoActivityDetect) {
    SetFieldUINT32Value(90, autoActivityDetect, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetSmartNotificationDisplayOrientation(
    ...
    SetFieldENUMValue(95, smartNotificationDisplayOrientation, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
