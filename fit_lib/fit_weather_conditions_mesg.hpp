...
class WeatherConditionsMesg : public Mesg {
 public:
  ...
  void SetPrecipitationProbability(FIT_UINT8 precipitationProbability) {
    SetFieldUINT8Value(5, precipitationProbability, 0,
  ...
  // Units: C
  // Comment: Heat Index if GCS heatIdx above or equal to 90F or wind chill if
  // GCS windChill below or equal to 32F
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetTemperatureFeelsLike(FIT_SINT8 temperatureFeelsLike) {
    SetFieldSINT8Value(6, temperatureFeelsLike, 0,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetObservedLocationLat(FIT_SINT32 observedLocationLat) {
    SetFieldSINT32Value(10, observedLocationLat, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetObservedLocationLong(FIT_SINT32 observedLocationLong) {
    SetFieldSINT32Value(11, observedLocationLong, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
