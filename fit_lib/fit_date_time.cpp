...
DateTime::DateTime(FIT_DATE_TIME timeStamp, FIT_FLOAT64 fractionalTimeStamp) {
  ...
  this->fractionalTimeStamp =
      fractionalTimeStamp - (FIT_FLOAT64)floor(fractionalTimeStamp);
}
...
FIT_DATE_TIME DateTime::GetTimeStamp() { return timeStamp; }

FIT_FLOAT64 DateTime::GetFractionalTimestamp() { return fractionalTimeStamp; }
...
void DateTime::add(FIT_DATE_TIME timestamp) { add(DateTime(timestamp)); }
...
int DateTime::CompareTo(DateTime t1) {
  // fractional_timestamp is guaranteed to be less that 1 which allows
  // simplified comparison below
