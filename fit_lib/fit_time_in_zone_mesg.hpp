...
class TimeInZoneMesg : public Mesg {
 public:
  ...
  void SetTimeInSpeedZone(FIT_UINT8 index, FIT_FLOAT32 timeInSpeedZone) {
    SetFieldFLOAT32Value(3, timeInSpeedZone, index,
  ...
  void SetTimeInCadenceZone(FIT_UINT8 index, FIT_FLOAT32 timeInCadenceZone) {
    SetFieldFLOAT32Value(4, timeInCadenceZone, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTimeInPowerZone(FIT_UINT8 index, FIT_FLOAT32 timeInPowerZone) {
    SetFieldFLOAT32Value(5, timeInPowerZone, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetHrZoneHighBoundary(FIT_UINT8 index, FIT_UINT8 hrZoneHighBoundary) {
    SetFieldUINT8Value(6, hrZoneHighBoundary, index,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Units: m/s
  ///////////////////////////////////////////////////////////////////////
  void SetSpeedZoneHighBoundary(FIT_UINT8 index,
                                FIT_FLOAT32 speedZoneHighBoundary) {
    SetFieldFLOAT32Value(7, speedZoneHighBoundary, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Units: rpm
  ///////////////////////////////////////////////////////////////////////
  void SetCadenceZoneHighBondary(FIT_UINT8 index,
                                 FIT_UINT8 cadenceZoneHighBondary) {
    SetFieldUINT8Value(8, cadenceZoneHighBondary, index,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Units: watts
  ///////////////////////////////////////////////////////////////////////
  void SetPowerZoneHighBoundary(FIT_UINT8 index,
                                FIT_UINT16 powerZoneHighBoundary) {
    SetFieldUINT16Value(9, powerZoneHighBoundary, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetThresholdHeartRate(FIT_UINT8 thresholdHeartRate) {
    SetFieldUINT8Value(13, thresholdHeartRate, 0,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetFunctionalThresholdPower(FIT_UINT16 functionalThresholdPower) {
    SetFieldUINT16Value(15, functionalThresholdPower, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
};
