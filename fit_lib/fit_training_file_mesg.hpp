 ...
 public:
  ...
  FIT_BOOL IsFaveroProductValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT)) {
      return FIT_FALSE;
    }

    return field->IsValueValid(
        0,
        (FIT_UINT16)Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
  }
  ...
  FIT_BOOL IsGarminProductValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT)) {
      return FIT_FALSE;
    }

    return field->IsValueValid(
        0,
        (FIT_UINT16)Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
  }
