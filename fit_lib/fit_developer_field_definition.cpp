...
DeveloperFieldDefinition::DeveloperFieldDefinition(
    const DeveloperFieldDefinition& other)
    : num(other.num),
      size(other.size),
...
DeveloperFieldDefinition::DeveloperFieldDefinition(
    const FieldDescriptionMesg& desc, const DeveloperDataIdMesg& developer,
    FIT_UINT8 size)
...
FIT_BOOL DeveloperFieldDefinition::operator==(
    const DeveloperFieldDefinition& field) const {
  if (num != field.num) return FIT_FALSE;

  if (developerDataIndex != field.developerDataIndex) return FIT_FALSE;
...
DeveloperFieldDefinition& DeveloperFieldDefinition::operator=(
    const DeveloperFieldDefinition& other) {
  if (this != &other) {
    num = other.num;
    size = other.size;
