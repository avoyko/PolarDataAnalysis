 ...
 public:
  ...
  FIT_BOOL IsBleDeviceTypeValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_BLE_DEVICE_TYPE)) {
      return FIT_FALSE;
    }
  ...
  FIT_BOOL IsAntplusDeviceTypeValid() const {
    ...
    return field->IsValueValid(
        0, (FIT_UINT16)
               Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANTPLUS_DEVICE_TYPE);
  }
  ...
  FIT_BOOL IsAntDeviceTypeValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_ANT_DEVICE_TYPE)) {
      return FIT_FALSE;
    }
  ...
  FIT_BOOL IsLocalDeviceTypeValid() const {
    ...
    return field->IsValueValid(
        0, (FIT_UINT16)
               Profile::DEVICE_INFO_MESG_DEVICE_TYPE_FIELD_LOCAL_DEVICE_TYPE);
  }
  ...
  FIT_BOOL IsFaveroProductValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_FAVERO_PRODUCT)) {
      return FIT_FALSE;
    }

    return field->IsValueValid(
        0, (FIT_UINT16)Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
  }
  ...
  FIT_FAVERO_PRODUCT GetFaveroProduct(void) const {
    return GetFieldUINT16Value(
        4, 0,
        (FIT_UINT16)Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
  }
  ...
  FIT_BOOL IsGarminProductValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_GARMIN_PRODUCT)) {
      return FIT_FALSE;
    }

    return field->IsValueValid(
        0, (FIT_UINT16)Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
  }
  ...
  FIT_GARMIN_PRODUCT GetGarminProduct(void) const {
    return GetFieldUINT16Value(
        4, 0,
        (FIT_UINT16)Profile::DEVICE_INFO_MESG_PRODUCT_FIELD_GARMIN_PRODUCT);
  }
  ...
  void SetAntTransmissionType(FIT_UINT8Z antTransmissionType) {
    SetFieldUINT8ZValue(20, antTransmissionType, 0,
