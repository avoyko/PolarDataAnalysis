...
class AviationAttitudeMesg : public Mesg {
 public:
  ...
  // Units: %
  // Comment: The percent complete of the current attitude stage. Set to 0 for
  // attitude stages 0, 1 and 2 and to 100 for attitude stage 3 by AHRS modules
  // that do not support it. Range - 100
  ///////////////////////////////////////////////////////////////////////
  ...
  // that do not support it. Range - 100
  ///////////////////////////////////////////////////////////////////////
  void SetAttitudeStageComplete(FIT_UINT8 index,
                                FIT_UINT8 attitudeStageComplete) {
    SetFieldUINT8Value(8, attitudeStageComplete, index,
