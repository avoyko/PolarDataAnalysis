...
class AccelerometerDataMesg : public Mesg {
 public:
  ...
  // Units: ms
  // Comment: Each time in the array describes the time at which the
  // accelerometer sample with the corrosponding index was taken. Limited to 30
  // samples in each message. The samples may span across seconds. Array size
  // must match the number of samples in accel_x and accel_y and accel_z
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetSampleTimeOffset(FIT_UINT8 index, FIT_UINT16 sampleTimeOffset) {
    SetFieldUINT16Value(1, sampleTimeOffset, index,
  ...
  // Units: counts
  // Comment: These are the raw ADC reading. Maximum number of samples is 30 in
  // each message. The samples may span across seconds. A conversion will need
  // to be done on this data once read.
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetCalibratedAccelX(FIT_UINT8 index, FIT_FLOAT32 calibratedAccelX) {
    SetFieldFLOAT32Value(5, calibratedAccelX, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCalibratedAccelY(FIT_UINT8 index, FIT_FLOAT32 calibratedAccelY) {
    SetFieldFLOAT32Value(6, calibratedAccelY, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCalibratedAccelZ(FIT_UINT8 index, FIT_FLOAT32 calibratedAccelZ) {
    SetFieldFLOAT32Value(7, calibratedAccelZ, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: Calibrated accel reading
  ///////////////////////////////////////////////////////////////////////
  void SetCompressedCalibratedAccelX(FIT_UINT8 index,
                                     FIT_SINT16 compressedCalibratedAccelX) {
    SetFieldSINT16Value(8, compressedCalibratedAccelX, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: Calibrated accel reading
  ///////////////////////////////////////////////////////////////////////
  void SetCompressedCalibratedAccelY(FIT_UINT8 index,
                                     FIT_SINT16 compressedCalibratedAccelY) {
    SetFieldSINT16Value(9, compressedCalibratedAccelY, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: Calibrated accel reading
  ///////////////////////////////////////////////////////////////////////
  void SetCompressedCalibratedAccelZ(FIT_UINT8 index,
                                     FIT_SINT16 compressedCalibratedAccelZ) {
    SetFieldSINT16Value(10, compressedCalibratedAccelZ, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
};
