...
const FIT_UINT8 baseTypeSizes[FIT_BASE_TYPES] = {
    sizeof(FIT_ENUM),    sizeof(FIT_SINT8),   sizeof(FIT_UINT8),
    sizeof(FIT_SINT16),  sizeof(FIT_UINT16),  sizeof(FIT_SINT32),
    sizeof(FIT_UINT32),  sizeof(FIT_STRING),  sizeof(FIT_FLOAT32),
    sizeof(FIT_FLOAT64), sizeof(FIT_UINT8Z),  sizeof(FIT_UINT16Z),
    sizeof(FIT_UINT32Z), sizeof(FIT_BYTE),    sizeof(FIT_SINT64),
...
DetailedProtocolVersion::DetailedProtocolVersion(FIT_UINT8 major,
                                                 FIT_UINT8 minor) {
  version = (major << FIT_PROTOCOL_VERSION_MAJOR_SHIFT) | minor;
}

FIT_UINT8 DetailedProtocolVersion::GetMajorVersion() const {
  return (version & FIT_PROTOCOL_VERSION_MAJOR_MASK) >>
...
FIT_UINT8 DetailedProtocolVersion::GetVersionByte() const { return version; }
