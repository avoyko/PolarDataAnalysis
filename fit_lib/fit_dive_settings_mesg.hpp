...
class DiveSettingsMesg : public Mesg {
 public:
  ...
  // Set name field
  ///////////////////////////////////////////////////////////////////////
  void SetName(FIT_WSTRING name) { SetFieldSTRINGValue(0, name, 0); }
  ...
  void SetApneaCountdownEnabled(FIT_BOOL apneaCountdownEnabled) {
    SetFieldENUMValue(12, apneaCountdownEnabled, 0,
  ...
  void SetApneaCountdownTime(FIT_UINT32 apneaCountdownTime) {
    SetFieldUINT32Value(13, apneaCountdownTime, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetBacklightBrightness(FIT_UINT8 backlightBrightness) {
    SetFieldUINT8Value(15, backlightBrightness, 0,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetRepeatDiveInterval(FIT_UINT16 repeatDiveInterval) {
    SetFieldUINT16Value(17, repeatDiveInterval, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetHeartRateSourceType(FIT_SOURCE_TYPE heartRateSourceType) {
    SetFieldENUMValue(19, heartRateSourceType, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  ///////////////////////////////////////////////////////////////////////
  void SetHeartRateAntplusDeviceType(
      FIT_ANTPLUS_DEVICE_TYPE heartRateAntplusDeviceType) {
    SetFieldUINT8Value(
  ...
  ///////////////////////////////////////////////////////////////////////
  void SetHeartRateLocalDeviceType(
      FIT_LOCAL_DEVICE_TYPE heartRateLocalDeviceType) {
    SetFieldUINT8Value(
  ...
  // Comment: If low PO2 should be switched to automatically
  ///////////////////////////////////////////////////////////////////////
  void SetCcrLowSetpointSwitchMode(
      FIT_CCR_SETPOINT_SWITCH_MODE ccrLowSetpointSwitchMode) {
    SetFieldENUMValue(22, ccrLowSetpointSwitchMode, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCcrLowSetpointDepth(FIT_FLOAT32 ccrLowSetpointDepth) {
    SetFieldFLOAT32Value(24, ccrLowSetpointDepth, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: If high PO2 should be switched to automatically
  ///////////////////////////////////////////////////////////////////////
  void SetCcrHighSetpointSwitchMode(
      FIT_CCR_SETPOINT_SWITCH_MODE ccrHighSetpointSwitchMode) {
    SetFieldENUMValue(25, ccrHighSetpointSwitchMode, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCcrHighSetpointDepth(FIT_FLOAT32 ccrHighSetpointDepth) {
    SetFieldFLOAT32Value(27, ccrHighSetpointDepth, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: Type of gas consumption rate to display. Some values are only
  ...
  // valid if tank volume is known.
  ///////////////////////////////////////////////////////////////////////
  void SetGasConsumptionDisplay(
      FIT_GAS_CONSUMPTION_RATE_TYPE gasConsumptionDisplay) {
    SetFieldENUMValue(29, gasConsumptionDisplay, 0,
                      FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetLastStopMultiple(FIT_FLOAT32 lastStopMultiple) {
    SetFieldFLOAT32Value(36, lastStopMultiple, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
