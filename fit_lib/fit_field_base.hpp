...
class FieldBase {
 public:
  ...
  virtual const Profile::SUBFIELD* GetSubField(
      const FIT_UINT16 subFieldIndex) const = 0;
  virtual FIT_UINT16 GetNumSubFields(void) const = 0;
  virtual const Profile::FIELD_COMPONENT* GetComponent(
      const FIT_UINT16 component) const = 0;
  ...
  FIT_SINT32 GetBitsSignedValue(const FIT_UINT16 offset,
  ...
  void AddRawValue(const FIT_FLOAT64 rawValue,
                   const FIT_UINT8 fieldArrayIndex = 0);
  ...
  void SetSINT8Value(const FIT_SINT8 value,
                     const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT8Value(const FIT_UINT8 value,
                     const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT8ZValue(const FIT_UINT8 value,
                      const FIT_UINT8 fieldArrayIndex = 0);
  void SetSINT16Value(const FIT_SINT16 value,
                      const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT16Value(const FIT_UINT16 value,
                      const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT16ZValue(const FIT_UINT16Z value,
                       const FIT_UINT8 fieldArrayIndex = 0);
  void SetSINT32Value(const FIT_SINT32 value,
                      const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT32Value(const FIT_UINT32 value,
                      const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT32ZValue(const FIT_UINT32Z value,
                       const FIT_UINT8 fieldArrayIndex = 0);
  void SetSINT64Value(const FIT_SINT64 value,
                      const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT64Value(const FIT_UINT64 value,
                      const FIT_UINT8 fieldArrayIndex = 0);
  void SetUINT64ZValue(const FIT_UINT64Z value,
                       const FIT_UINT8 fieldArrayIndex = 0);
  void SetFLOAT32Value(
      const FIT_FLOAT32 value, const FIT_UINT8 fieldArrayIndex = 0,
      const FIT_UINT16 subFieldIndex = FIT_SUBFIELD_INDEX_MAIN_FIELD);
  void SetFLOAT64Value(
      const FIT_FLOAT64 value, const FIT_UINT8 fieldArrayIndex = 0,
      const FIT_UINT16 subFieldIndex = FIT_SUBFIELD_INDEX_MAIN_FIELD);
  void SetSTRINGValue(const FIT_WSTRING& value,
                      const FIT_UINT8 fieldArrayIndex = 0);
 ...
 private:
  ...
  TTo ConvertBaseType(const FIT_UINT8 fieldArrayIndex,
                      const FIT_UINT8 toBaseType) const;

  FIT_BOOL GetMemoryValue(const FIT_UINT8 fieldArrayIndex, FIT_UINT8* buffer,
