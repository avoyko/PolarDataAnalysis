...
class SegmentFileMesg : public Mesg {
 public:
  ...
  void SetUserProfilePrimaryKey(FIT_UINT32 userProfilePrimaryKey) {
    SetFieldUINT32Value(4, userProfilePrimaryKey, 0,
  ...
  // Comment: Group primary key of each leader in the segment file
  ///////////////////////////////////////////////////////////////////////
  void SetLeaderGroupPrimaryKey(FIT_UINT8 index,
                                FIT_UINT32 leaderGroupPrimaryKey) {
    SetFieldUINT32Value(8, leaderGroupPrimaryKey, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetLeaderActivityId(FIT_UINT8 index, FIT_UINT32 leaderActivityId) {
    SetFieldUINT32Value(9, leaderActivityId, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: String version of the activity ID of each leader in the segment
  ...
  // file. 21 characters long for each ID, express in decimal
  ///////////////////////////////////////////////////////////////////////
  void SetLeaderActivityIdString(FIT_UINT8 index,
                                 FIT_WSTRING leaderActivityIdString) {
  ...
  // Comment: Index for the Leader Board entry selected as the default race
  // participant
  ///////////////////////////////////////////////////////////////////////
