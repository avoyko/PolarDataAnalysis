...
class TimestampCorrelationMesg : public Mesg {
 public:
  ...
  // Units: s
  // Comment: Whole second part of UTC timestamp at the time the system
  ...
  // Units: s
  // Comment: Fractional part of the UTC timestamp at the time the system
  // timestamp was recorded.
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetFractionalTimestamp(FIT_FLOAT32 fractionalTimestamp) {
    SetFieldFLOAT32Value(0, fractionalTimestamp, 0,
  ...
  void SetFractionalSystemTimestamp(FIT_FLOAT32 fractionalSystemTimestamp) {
    SetFieldFLOAT32Value(2, fractionalSystemTimestamp, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Units: s
  // Comment: timestamp epoch expressed in local time used to convert timestamps
  // to local time
  ///////////////////////////////////////////////////////////////////////
  ...
  // Units: ms
  // Comment: Millisecond part of the UTC timestamp at the time the system
  // timestamp was recorded.
  ///////////////////////////////////////////////////////////////////////
