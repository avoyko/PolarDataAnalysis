...
class MagnetometerDataMesg : public Mesg {
 public:
  ...
  // Units: ms
  // Comment: Each time in the array describes the time at which the compass
  // sample with the corrosponding index was taken. Limited to 30 samples in
  // each message. The samples may span across seconds. Array size must match
  // the number of samples in cmps_x and cmps_y and cmps_z
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetCalibratedMagX(FIT_UINT8 index, FIT_FLOAT32 calibratedMagX) {
    SetFieldFLOAT32Value(5, calibratedMagX, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCalibratedMagY(FIT_UINT8 index, FIT_FLOAT32 calibratedMagY) {
    SetFieldFLOAT32Value(6, calibratedMagY, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCalibratedMagZ(FIT_UINT8 index, FIT_FLOAT32 calibratedMagZ) {
    SetFieldFLOAT32Value(7, calibratedMagZ, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
};
