 ...
 public:
  ...
  FIT_BOOL IsNumPerFileValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::MESG_CAPABILITIES_MESG_COUNT_FIELD_NUM_PER_FILE)) {
      return FIT_FALSE;
    }

    return field->IsValueValid(
        0,
        (FIT_UINT16)Profile::MESG_CAPABILITIES_MESG_COUNT_FIELD_NUM_PER_FILE);
  }
  ...
  FIT_BOOL IsMaxPerFileValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::MESG_CAPABILITIES_MESG_COUNT_FIELD_MAX_PER_FILE)) {
      return FIT_FALSE;
    }

    return field->IsValueValid(
        0,
        (FIT_UINT16)Profile::MESG_CAPABILITIES_MESG_COUNT_FIELD_MAX_PER_FILE);
  }
  ...
  FIT_BOOL IsMaxPerFileTypeValid() const {
    ...
    return field->IsValueValid(
        0, (FIT_UINT16)
               Profile::MESG_CAPABILITIES_MESG_COUNT_FIELD_MAX_PER_FILE_TYPE);
  }
