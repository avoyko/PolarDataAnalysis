...
class BloodPressureMesg : public Mesg {
 public:
  ...
  void SetMeanArterialPressure(FIT_UINT16 meanArterialPressure) {
    SetFieldUINT16Value(2, meanArterialPressure, 0,
  ...
  // Comment: Associates this blood pressure message to a user. This corresponds
  // to the index of the user profile message in the blood pressure file.
  ///////////////////////////////////////////////////////////////////////
