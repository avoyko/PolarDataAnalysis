...
class ThreeDSensorAdjustmentPlugin : public fit::MesgBroadcastPlugin {
 public:
  ...
  ThreeDSensorAdjustmentPlugin& operator=(const ThreeDSensorAdjustmentPlugin&) =
      delete;
 ...
 private:
  ...
  void adjustSensorData(FIT_FLOAT32 (&rawData)[3],
                        CalibrationParameters calParams);
  void ProcessCalibrationFactor(fit::Mesg& mesg, const FIT_UINT8* fieldsXYZ,
