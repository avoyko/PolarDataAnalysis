...
class GyroscopeDataMesg : public Mesg {
 public:
  ...
  // Units: ms
  // Comment: Each time in the array describes the time at which the gyro sample
  // with the corrosponding index was taken. Limited to 30 samples in each
  // message. The samples may span across seconds. Array size must match the
  ...
  void SetCalibratedGyroX(FIT_UINT8 index, FIT_FLOAT32 calibratedGyroX) {
    SetFieldFLOAT32Value(5, calibratedGyroX, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCalibratedGyroY(FIT_UINT8 index, FIT_FLOAT32 calibratedGyroY) {
    SetFieldFLOAT32Value(6, calibratedGyroY, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetCalibratedGyroZ(FIT_UINT8 index, FIT_FLOAT32 calibratedGyroZ) {
    SetFieldFLOAT32Value(7, calibratedGyroZ, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
};
