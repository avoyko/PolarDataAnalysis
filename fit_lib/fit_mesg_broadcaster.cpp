...
void MesgBroadcaster::AddListener(
    MesgDefinitionListener& mesgDefinitionListener) {
  mesgDefinitionListeners.push_back(&mesgDefinitionListener);
}

void MesgBroadcaster::RemoveListener(
    MesgDefinitionListener& mesgDefinitionListener) {
  mesgDefinitionListeners.erase(std::find(mesgDefinitionListeners.begin(),
                                          mesgDefinitionListeners.end(),
...
void MesgBroadcaster::RemoveListener(MesgListener& mesgListener) {
  mesgListeners.erase(
      std::find(mesgListeners.begin(), mesgListeners.end(), &mesgListener));
}
...
void MesgBroadcaster::AddListener(
    BufferedRecordMesgListener& bufferedRecordMesgListener) {
...
void MesgBroadcaster::RemoveListener(FileIdMesgListener& fileIdMesgListener) {
  std::vector<FileIdMesgListener*>::iterator it =
      std::find(fileIdMesgListeners.begin(), fileIdMesgListeners.end(),
                &fileIdMesgListener);
  if (fileIdMesgListeners.end() != it) fileIdMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    FileCreatorMesgListener& fileCreatorMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<FileCreatorMesgListener*>::iterator it =
      std::find(fileCreatorMesgListeners.begin(),
                fileCreatorMesgListeners.end(), &fileCreatorMesgListener);
  if (fileCreatorMesgListeners.end() != it) fileCreatorMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    TimestampCorrelationMesgListener& timestampCorrelationMesgListener) {
  timestampCorrelationMesgListeners.push_back(
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<TimestampCorrelationMesgListener*>::iterator it =
      std::find(timestampCorrelationMesgListeners.begin(),
                timestampCorrelationMesgListeners.end(),
                &timestampCorrelationMesgListener);
...
void MesgBroadcaster::RemoveListener(
    SoftwareMesgListener& softwareMesgListener) {
  std::vector<SoftwareMesgListener*>::iterator it =
      std::find(softwareMesgListeners.begin(), softwareMesgListeners.end(),
                &softwareMesgListener);
  if (softwareMesgListeners.end() != it) softwareMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SlaveDeviceMesgListener& slaveDeviceMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SlaveDeviceMesgListener*>::iterator it =
      std::find(slaveDeviceMesgListeners.begin(),
                slaveDeviceMesgListeners.end(), &slaveDeviceMesgListener);
  if (slaveDeviceMesgListeners.end() != it) slaveDeviceMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    CapabilitiesMesgListener& capabilitiesMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<CapabilitiesMesgListener*>::iterator it =
      std::find(capabilitiesMesgListeners.begin(),
                capabilitiesMesgListeners.end(), &capabilitiesMesgListener);
  if (capabilitiesMesgListeners.end() != it)
    capabilitiesMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    FileCapabilitiesMesgListener& fileCapabilitiesMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<FileCapabilitiesMesgListener*>::iterator it = std::find(
      fileCapabilitiesMesgListeners.begin(),
      fileCapabilitiesMesgListeners.end(), &fileCapabilitiesMesgListener);
  if (fileCapabilitiesMesgListeners.end() != it)
    fileCapabilitiesMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    MesgCapabilitiesMesgListener& mesgCapabilitiesMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<MesgCapabilitiesMesgListener*>::iterator it = std::find(
      mesgCapabilitiesMesgListeners.begin(),
      mesgCapabilitiesMesgListeners.end(), &mesgCapabilitiesMesgListener);
  if (mesgCapabilitiesMesgListeners.end() != it)
    mesgCapabilitiesMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    FieldCapabilitiesMesgListener& fieldCapabilitiesMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<FieldCapabilitiesMesgListener*>::iterator it = std::find(
      fieldCapabilitiesMesgListeners.begin(),
      fieldCapabilitiesMesgListeners.end(), &fieldCapabilitiesMesgListener);
  if (fieldCapabilitiesMesgListeners.end() != it)
    fieldCapabilitiesMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    DeviceSettingsMesgListener& deviceSettingsMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DeviceSettingsMesgListener*>::iterator it =
      std::find(deviceSettingsMesgListeners.begin(),
                deviceSettingsMesgListeners.end(), &deviceSettingsMesgListener);
  if (deviceSettingsMesgListeners.end() != it)
    deviceSettingsMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    UserProfileMesgListener& userProfileMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<UserProfileMesgListener*>::iterator it =
      std::find(userProfileMesgListeners.begin(),
                userProfileMesgListeners.end(), &userProfileMesgListener);
  if (userProfileMesgListeners.end() != it) userProfileMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    HrmProfileMesgListener& hrmProfileMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<HrmProfileMesgListener*>::iterator it =
      std::find(hrmProfileMesgListeners.begin(), hrmProfileMesgListeners.end(),
                &hrmProfileMesgListener);
  if (hrmProfileMesgListeners.end() != it) hrmProfileMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SdmProfileMesgListener& sdmProfileMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SdmProfileMesgListener*>::iterator it =
      std::find(sdmProfileMesgListeners.begin(), sdmProfileMesgListeners.end(),
                &sdmProfileMesgListener);
  if (sdmProfileMesgListeners.end() != it) sdmProfileMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    BikeProfileMesgListener& bikeProfileMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<BikeProfileMesgListener*>::iterator it =
      std::find(bikeProfileMesgListeners.begin(),
                bikeProfileMesgListeners.end(), &bikeProfileMesgListener);
  if (bikeProfileMesgListeners.end() != it) bikeProfileMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    ConnectivityMesgListener& connectivityMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ConnectivityMesgListener*>::iterator it =
      std::find(connectivityMesgListeners.begin(),
                connectivityMesgListeners.end(), &connectivityMesgListener);
  if (connectivityMesgListeners.end() != it)
    connectivityMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    WatchfaceSettingsMesgListener& watchfaceSettingsMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<WatchfaceSettingsMesgListener*>::iterator it = std::find(
      watchfaceSettingsMesgListeners.begin(),
      watchfaceSettingsMesgListeners.end(), &watchfaceSettingsMesgListener);
  if (watchfaceSettingsMesgListeners.end() != it)
    watchfaceSettingsMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    OhrSettingsMesgListener& ohrSettingsMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<OhrSettingsMesgListener*>::iterator it =
      std::find(ohrSettingsMesgListeners.begin(),
                ohrSettingsMesgListeners.end(), &ohrSettingsMesgListener);
  if (ohrSettingsMesgListeners.end() != it) ohrSettingsMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    TimeInZoneMesgListener& timeInZoneMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<TimeInZoneMesgListener*>::iterator it =
      std::find(timeInZoneMesgListeners.begin(), timeInZoneMesgListeners.end(),
                &timeInZoneMesgListener);
  if (timeInZoneMesgListeners.end() != it) timeInZoneMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    ZonesTargetMesgListener& zonesTargetMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ZonesTargetMesgListener*>::iterator it =
      std::find(zonesTargetMesgListeners.begin(),
                zonesTargetMesgListeners.end(), &zonesTargetMesgListener);
  if (zonesTargetMesgListeners.end() != it) zonesTargetMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(SportMesgListener& sportMesgListener) {
  std::vector<SportMesgListener*>::iterator it = std::find(
      sportMesgListeners.begin(), sportMesgListeners.end(), &sportMesgListener);
  if (sportMesgListeners.end() != it) sportMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(HrZoneMesgListener& hrZoneMesgListener) {
  std::vector<HrZoneMesgListener*>::iterator it =
      std::find(hrZoneMesgListeners.begin(), hrZoneMesgListeners.end(),
                &hrZoneMesgListener);
  if (hrZoneMesgListeners.end() != it) hrZoneMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SpeedZoneMesgListener& speedZoneMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SpeedZoneMesgListener*>::iterator it =
      std::find(speedZoneMesgListeners.begin(), speedZoneMesgListeners.end(),
                &speedZoneMesgListener);
  if (speedZoneMesgListeners.end() != it) speedZoneMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    CadenceZoneMesgListener& cadenceZoneMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<CadenceZoneMesgListener*>::iterator it =
      std::find(cadenceZoneMesgListeners.begin(),
                cadenceZoneMesgListeners.end(), &cadenceZoneMesgListener);
  if (cadenceZoneMesgListeners.end() != it) cadenceZoneMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    PowerZoneMesgListener& powerZoneMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<PowerZoneMesgListener*>::iterator it =
      std::find(powerZoneMesgListeners.begin(), powerZoneMesgListeners.end(),
                &powerZoneMesgListener);
  if (powerZoneMesgListeners.end() != it) powerZoneMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(MetZoneMesgListener& metZoneMesgListener) {
  std::vector<MetZoneMesgListener*>::iterator it =
      std::find(metZoneMesgListeners.begin(), metZoneMesgListeners.end(),
                &metZoneMesgListener);
  if (metZoneMesgListeners.end() != it) metZoneMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    DiveSettingsMesgListener& diveSettingsMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DiveSettingsMesgListener*>::iterator it =
      std::find(diveSettingsMesgListeners.begin(),
                diveSettingsMesgListeners.end(), &diveSettingsMesgListener);
  if (diveSettingsMesgListeners.end() != it)
    diveSettingsMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    DiveAlarmMesgListener& diveAlarmMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DiveAlarmMesgListener*>::iterator it =
      std::find(diveAlarmMesgListeners.begin(), diveAlarmMesgListeners.end(),
                &diveAlarmMesgListener);
  if (diveAlarmMesgListeners.end() != it) diveAlarmMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    DiveApneaAlarmMesgListener& diveApneaAlarmMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DiveApneaAlarmMesgListener*>::iterator it =
      std::find(diveApneaAlarmMesgListeners.begin(),
                diveApneaAlarmMesgListeners.end(), &diveApneaAlarmMesgListener);
...
void MesgBroadcaster::RemoveListener(DiveGasMesgListener& diveGasMesgListener) {
  std::vector<DiveGasMesgListener*>::iterator it =
      std::find(diveGasMesgListeners.begin(), diveGasMesgListeners.end(),
                &diveGasMesgListener);
  if (diveGasMesgListeners.end() != it) diveGasMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(GoalMesgListener& goalMesgListener) {
  std::vector<GoalMesgListener*>::iterator it = std::find(
      goalMesgListeners.begin(), goalMesgListeners.end(), &goalMesgListener);
  if (goalMesgListeners.end() != it) goalMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(
    ActivityMesgListener& activityMesgListener) {
  std::vector<ActivityMesgListener*>::iterator it =
      std::find(activityMesgListeners.begin(), activityMesgListeners.end(),
                &activityMesgListener);
  if (activityMesgListeners.end() != it) activityMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(SessionMesgListener& sessionMesgListener) {
  std::vector<SessionMesgListener*>::iterator it =
      std::find(sessionMesgListeners.begin(), sessionMesgListeners.end(),
                &sessionMesgListener);
  if (sessionMesgListeners.end() != it) sessionMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(LapMesgListener& lapMesgListener) {
  std::vector<LapMesgListener*>::iterator it = std::find(
      lapMesgListeners.begin(), lapMesgListeners.end(), &lapMesgListener);
  if (lapMesgListeners.end() != it) lapMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(LengthMesgListener& lengthMesgListener) {
  std::vector<LengthMesgListener*>::iterator it =
      std::find(lengthMesgListeners.begin(), lengthMesgListeners.end(),
                &lengthMesgListener);
  if (lengthMesgListeners.end() != it) lengthMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(RecordMesgListener& recordMesgListener) {
  std::vector<RecordMesgListener*>::iterator it =
      std::find(recordMesgListeners.begin(), recordMesgListeners.end(),
                &recordMesgListener);
  if (recordMesgListeners.end() != it) recordMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(EventMesgListener& eventMesgListener) {
  std::vector<EventMesgListener*>::iterator it = std::find(
      eventMesgListeners.begin(), eventMesgListeners.end(), &eventMesgListener);
  if (eventMesgListeners.end() != it) eventMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    DeviceInfoMesgListener& deviceInfoMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DeviceInfoMesgListener*>::iterator it =
      std::find(deviceInfoMesgListeners.begin(), deviceInfoMesgListeners.end(),
                &deviceInfoMesgListener);
  if (deviceInfoMesgListeners.end() != it) deviceInfoMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    DeviceAuxBatteryInfoMesgListener& deviceAuxBatteryInfoMesgListener) {
  deviceAuxBatteryInfoMesgListeners.push_back(
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DeviceAuxBatteryInfoMesgListener*>::iterator it =
      std::find(deviceAuxBatteryInfoMesgListeners.begin(),
                deviceAuxBatteryInfoMesgListeners.end(),
                &deviceAuxBatteryInfoMesgListener);
...
void MesgBroadcaster::AddListener(
    TrainingFileMesgListener& trainingFileMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<TrainingFileMesgListener*>::iterator it =
      std::find(trainingFileMesgListeners.begin(),
                trainingFileMesgListeners.end(), &trainingFileMesgListener);
  if (trainingFileMesgListeners.end() != it)
    trainingFileMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    WeatherConditionsMesgListener& weatherConditionsMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<WeatherConditionsMesgListener*>::iterator it = std::find(
      weatherConditionsMesgListeners.begin(),
      weatherConditionsMesgListeners.end(), &weatherConditionsMesgListener);
  if (weatherConditionsMesgListeners.end() != it)
    weatherConditionsMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    WeatherAlertMesgListener& weatherAlertMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<WeatherAlertMesgListener*>::iterator it =
      std::find(weatherAlertMesgListeners.begin(),
                weatherAlertMesgListeners.end(), &weatherAlertMesgListener);
  if (weatherAlertMesgListeners.end() != it)
    weatherAlertMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    GpsMetadataMesgListener& gpsMetadataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<GpsMetadataMesgListener*>::iterator it =
      std::find(gpsMetadataMesgListeners.begin(),
                gpsMetadataMesgListeners.end(), &gpsMetadataMesgListener);
  if (gpsMetadataMesgListeners.end() != it) gpsMetadataMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    CameraEventMesgListener& cameraEventMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<CameraEventMesgListener*>::iterator it =
      std::find(cameraEventMesgListeners.begin(),
                cameraEventMesgListeners.end(), &cameraEventMesgListener);
  if (cameraEventMesgListeners.end() != it) cameraEventMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    GyroscopeDataMesgListener& gyroscopeDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<GyroscopeDataMesgListener*>::iterator it =
      std::find(gyroscopeDataMesgListeners.begin(),
                gyroscopeDataMesgListeners.end(), &gyroscopeDataMesgListener);
  if (gyroscopeDataMesgListeners.end() != it)
    gyroscopeDataMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    AccelerometerDataMesgListener& accelerometerDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<AccelerometerDataMesgListener*>::iterator it = std::find(
      accelerometerDataMesgListeners.begin(),
      accelerometerDataMesgListeners.end(), &accelerometerDataMesgListener);
  if (accelerometerDataMesgListeners.end() != it)
    accelerometerDataMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    MagnetometerDataMesgListener& magnetometerDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<MagnetometerDataMesgListener*>::iterator it = std::find(
      magnetometerDataMesgListeners.begin(),
      magnetometerDataMesgListeners.end(), &magnetometerDataMesgListener);
  if (magnetometerDataMesgListeners.end() != it)
    magnetometerDataMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    BarometerDataMesgListener& barometerDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<BarometerDataMesgListener*>::iterator it =
      std::find(barometerDataMesgListeners.begin(),
                barometerDataMesgListeners.end(), &barometerDataMesgListener);
  if (barometerDataMesgListeners.end() != it)
    barometerDataMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    ThreeDSensorCalibrationMesgListener& threeDSensorCalibrationMesgListener) {
  threeDSensorCalibrationMesgListeners.push_back(
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ThreeDSensorCalibrationMesgListener*>::iterator it =
      std::find(threeDSensorCalibrationMesgListeners.begin(),
                threeDSensorCalibrationMesgListeners.end(),
                &threeDSensorCalibrationMesgListener);
...
void MesgBroadcaster::AddListener(
    OneDSensorCalibrationMesgListener& oneDSensorCalibrationMesgListener) {
  oneDSensorCalibrationMesgListeners.push_back(
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<OneDSensorCalibrationMesgListener*>::iterator it =
      std::find(oneDSensorCalibrationMesgListeners.begin(),
                oneDSensorCalibrationMesgListeners.end(),
                &oneDSensorCalibrationMesgListener);
...
void MesgBroadcaster::AddListener(
    VideoFrameMesgListener& videoFrameMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<VideoFrameMesgListener*>::iterator it =
      std::find(videoFrameMesgListeners.begin(), videoFrameMesgListeners.end(),
                &videoFrameMesgListener);
  if (videoFrameMesgListeners.end() != it) videoFrameMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    ObdiiDataMesgListener& obdiiDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ObdiiDataMesgListener*>::iterator it =
      std::find(obdiiDataMesgListeners.begin(), obdiiDataMesgListeners.end(),
                &obdiiDataMesgListener);
  if (obdiiDataMesgListeners.end() != it) obdiiDataMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    NmeaSentenceMesgListener& nmeaSentenceMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<NmeaSentenceMesgListener*>::iterator it =
      std::find(nmeaSentenceMesgListeners.begin(),
                nmeaSentenceMesgListeners.end(), &nmeaSentenceMesgListener);
  if (nmeaSentenceMesgListeners.end() != it)
    nmeaSentenceMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    AviationAttitudeMesgListener& aviationAttitudeMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<AviationAttitudeMesgListener*>::iterator it = std::find(
      aviationAttitudeMesgListeners.begin(),
      aviationAttitudeMesgListeners.end(), &aviationAttitudeMesgListener);
...
void MesgBroadcaster::RemoveListener(VideoMesgListener& videoMesgListener) {
  std::vector<VideoMesgListener*>::iterator it = std::find(
      videoMesgListeners.begin(), videoMesgListeners.end(), &videoMesgListener);
  if (videoMesgListeners.end() != it) videoMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    VideoTitleMesgListener& videoTitleMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<VideoTitleMesgListener*>::iterator it =
      std::find(videoTitleMesgListeners.begin(), videoTitleMesgListeners.end(),
                &videoTitleMesgListener);
  if (videoTitleMesgListeners.end() != it) videoTitleMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    VideoDescriptionMesgListener& videoDescriptionMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<VideoDescriptionMesgListener*>::iterator it = std::find(
      videoDescriptionMesgListeners.begin(),
      videoDescriptionMesgListeners.end(), &videoDescriptionMesgListener);
  if (videoDescriptionMesgListeners.end() != it)
    videoDescriptionMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    VideoClipMesgListener& videoClipMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<VideoClipMesgListener*>::iterator it =
      std::find(videoClipMesgListeners.begin(), videoClipMesgListeners.end(),
                &videoClipMesgListener);
  if (videoClipMesgListeners.end() != it) videoClipMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(SetMesgListener& setMesgListener) {
  std::vector<SetMesgListener*>::iterator it = std::find(
      setMesgListeners.begin(), setMesgListeners.end(), &setMesgListener);
  if (setMesgListeners.end() != it) setMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(JumpMesgListener& jumpMesgListener) {
  std::vector<JumpMesgListener*>::iterator it = std::find(
      jumpMesgListeners.begin(), jumpMesgListeners.end(), &jumpMesgListener);
  if (jumpMesgListeners.end() != it) jumpMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(SplitMesgListener& splitMesgListener) {
  std::vector<SplitMesgListener*>::iterator it = std::find(
      splitMesgListeners.begin(), splitMesgListeners.end(), &splitMesgListener);
  if (splitMesgListeners.end() != it) splitMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SplitSummaryMesgListener& splitSummaryMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SplitSummaryMesgListener*>::iterator it =
      std::find(splitSummaryMesgListeners.begin(),
                splitSummaryMesgListeners.end(), &splitSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(
    ClimbProMesgListener& climbProMesgListener) {
  std::vector<ClimbProMesgListener*>::iterator it =
      std::find(climbProMesgListeners.begin(), climbProMesgListeners.end(),
                &climbProMesgListener);
  if (climbProMesgListeners.end() != it) climbProMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    FieldDescriptionMesgListener& fieldDescriptionMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<FieldDescriptionMesgListener*>::iterator it = std::find(
      fieldDescriptionMesgListeners.begin(),
      fieldDescriptionMesgListeners.end(), &fieldDescriptionMesgListener);
  if (fieldDescriptionMesgListeners.end() != it)
    fieldDescriptionMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    DeveloperDataIdMesgListener& developerDataIdMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DeveloperDataIdMesgListener*>::iterator it = std::find(
      developerDataIdMesgListeners.begin(), developerDataIdMesgListeners.end(),
      &developerDataIdMesgListener);
...
void MesgBroadcaster::RemoveListener(CourseMesgListener& courseMesgListener) {
  std::vector<CourseMesgListener*>::iterator it =
      std::find(courseMesgListeners.begin(), courseMesgListeners.end(),
                &courseMesgListener);
  if (courseMesgListeners.end() != it) courseMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    CoursePointMesgListener& coursePointMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<CoursePointMesgListener*>::iterator it =
      std::find(coursePointMesgListeners.begin(),
                coursePointMesgListeners.end(), &coursePointMesgListener);
  if (coursePointMesgListeners.end() != it) coursePointMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SegmentIdMesgListener& segmentIdMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SegmentIdMesgListener*>::iterator it =
      std::find(segmentIdMesgListeners.begin(), segmentIdMesgListeners.end(),
                &segmentIdMesgListener);
  if (segmentIdMesgListeners.end() != it) segmentIdMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SegmentLeaderboardEntryMesgListener& segmentLeaderboardEntryMesgListener) {
  segmentLeaderboardEntryMesgListeners.push_back(
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SegmentLeaderboardEntryMesgListener*>::iterator it =
      std::find(segmentLeaderboardEntryMesgListeners.begin(),
                segmentLeaderboardEntryMesgListeners.end(),
                &segmentLeaderboardEntryMesgListener);
...
void MesgBroadcaster::AddListener(
    SegmentPointMesgListener& segmentPointMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SegmentPointMesgListener*>::iterator it =
      std::find(segmentPointMesgListeners.begin(),
                segmentPointMesgListeners.end(), &segmentPointMesgListener);
  if (segmentPointMesgListeners.end() != it)
    segmentPointMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SegmentLapMesgListener& segmentLapMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SegmentLapMesgListener*>::iterator it =
      std::find(segmentLapMesgListeners.begin(), segmentLapMesgListeners.end(),
                &segmentLapMesgListener);
  if (segmentLapMesgListeners.end() != it) segmentLapMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SegmentFileMesgListener& segmentFileMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SegmentFileMesgListener*>::iterator it =
      std::find(segmentFileMesgListeners.begin(),
                segmentFileMesgListeners.end(), &segmentFileMesgListener);
  if (segmentFileMesgListeners.end() != it) segmentFileMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(WorkoutMesgListener& workoutMesgListener) {
  std::vector<WorkoutMesgListener*>::iterator it =
      std::find(workoutMesgListeners.begin(), workoutMesgListeners.end(),
                &workoutMesgListener);
  if (workoutMesgListeners.end() != it) workoutMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    WorkoutSessionMesgListener& workoutSessionMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<WorkoutSessionMesgListener*>::iterator it =
      std::find(workoutSessionMesgListeners.begin(),
                workoutSessionMesgListeners.end(), &workoutSessionMesgListener);
  if (workoutSessionMesgListeners.end() != it)
    workoutSessionMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    WorkoutStepMesgListener& workoutStepMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<WorkoutStepMesgListener*>::iterator it =
      std::find(workoutStepMesgListeners.begin(),
                workoutStepMesgListeners.end(), &workoutStepMesgListener);
  if (workoutStepMesgListeners.end() != it) workoutStepMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    ExerciseTitleMesgListener& exerciseTitleMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ExerciseTitleMesgListener*>::iterator it =
      std::find(exerciseTitleMesgListeners.begin(),
                exerciseTitleMesgListeners.end(), &exerciseTitleMesgListener);
...
void MesgBroadcaster::RemoveListener(
    ScheduleMesgListener& scheduleMesgListener) {
  std::vector<ScheduleMesgListener*>::iterator it =
      std::find(scheduleMesgListeners.begin(), scheduleMesgListeners.end(),
                &scheduleMesgListener);
  if (scheduleMesgListeners.end() != it) scheduleMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(TotalsMesgListener& totalsMesgListener) {
  std::vector<TotalsMesgListener*>::iterator it =
      std::find(totalsMesgListeners.begin(), totalsMesgListeners.end(),
                &totalsMesgListener);
  if (totalsMesgListeners.end() != it) totalsMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    WeightScaleMesgListener& weightScaleMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<WeightScaleMesgListener*>::iterator it =
      std::find(weightScaleMesgListeners.begin(),
                weightScaleMesgListeners.end(), &weightScaleMesgListener);
  if (weightScaleMesgListeners.end() != it) weightScaleMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    BloodPressureMesgListener& bloodPressureMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<BloodPressureMesgListener*>::iterator it =
      std::find(bloodPressureMesgListeners.begin(),
                bloodPressureMesgListeners.end(), &bloodPressureMesgListener);
  if (bloodPressureMesgListeners.end() != it)
    bloodPressureMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    MonitoringInfoMesgListener& monitoringInfoMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<MonitoringInfoMesgListener*>::iterator it =
      std::find(monitoringInfoMesgListeners.begin(),
                monitoringInfoMesgListeners.end(), &monitoringInfoMesgListener);
  if (monitoringInfoMesgListeners.end() != it)
    monitoringInfoMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    MonitoringMesgListener& monitoringMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<MonitoringMesgListener*>::iterator it =
      std::find(monitoringMesgListeners.begin(), monitoringMesgListeners.end(),
                &monitoringMesgListener);
  if (monitoringMesgListeners.end() != it) monitoringMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    MonitoringHrDataMesgListener& monitoringHrDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<MonitoringHrDataMesgListener*>::iterator it = std::find(
      monitoringHrDataMesgListeners.begin(),
      monitoringHrDataMesgListeners.end(), &monitoringHrDataMesgListener);
...
void MesgBroadcaster::RemoveListener(
    Spo2DataMesgListener& spo2DataMesgListener) {
  std::vector<Spo2DataMesgListener*>::iterator it =
      std::find(spo2DataMesgListeners.begin(), spo2DataMesgListeners.end(),
                &spo2DataMesgListener);
  if (spo2DataMesgListeners.end() != it) spo2DataMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(HrMesgListener& hrMesgListener) {
  std::vector<HrMesgListener*>::iterator it = std::find(
      hrMesgListeners.begin(), hrMesgListeners.end(), &hrMesgListener);
  if (hrMesgListeners.end() != it) hrMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    StressLevelMesgListener& stressLevelMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<StressLevelMesgListener*>::iterator it =
      std::find(stressLevelMesgListeners.begin(),
                stressLevelMesgListeners.end(), &stressLevelMesgListener);
  if (stressLevelMesgListeners.end() != it) stressLevelMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    MaxMetDataMesgListener& maxMetDataMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<MaxMetDataMesgListener*>::iterator it =
      std::find(maxMetDataMesgListeners.begin(), maxMetDataMesgListeners.end(),
                &maxMetDataMesgListener);
  if (maxMetDataMesgListeners.end() != it) maxMetDataMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(
    MemoGlobMesgListener& memoGlobMesgListener) {
  std::vector<MemoGlobMesgListener*>::iterator it =
      std::find(memoGlobMesgListeners.begin(), memoGlobMesgListeners.end(),
                &memoGlobMesgListener);
  if (memoGlobMesgListeners.end() != it) memoGlobMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SleepLevelMesgListener& sleepLevelMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SleepLevelMesgListener*>::iterator it =
      std::find(sleepLevelMesgListeners.begin(), sleepLevelMesgListeners.end(),
                &sleepLevelMesgListener);
  if (sleepLevelMesgListeners.end() != it) sleepLevelMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    AntChannelIdMesgListener& antChannelIdMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<AntChannelIdMesgListener*>::iterator it =
      std::find(antChannelIdMesgListeners.begin(),
                antChannelIdMesgListeners.end(), &antChannelIdMesgListener);
...
void MesgBroadcaster::RemoveListener(AntRxMesgListener& antRxMesgListener) {
  std::vector<AntRxMesgListener*>::iterator it = std::find(
      antRxMesgListeners.begin(), antRxMesgListeners.end(), &antRxMesgListener);
  if (antRxMesgListeners.end() != it) antRxMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(AntTxMesgListener& antTxMesgListener) {
  std::vector<AntTxMesgListener*>::iterator it = std::find(
      antTxMesgListeners.begin(), antTxMesgListeners.end(), &antTxMesgListener);
  if (antTxMesgListeners.end() != it) antTxMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    ExdScreenConfigurationMesgListener& exdScreenConfigurationMesgListener) {
  exdScreenConfigurationMesgListeners.push_back(
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ExdScreenConfigurationMesgListener*>::iterator it =
      std::find(exdScreenConfigurationMesgListeners.begin(),
                exdScreenConfigurationMesgListeners.end(),
                &exdScreenConfigurationMesgListener);
  if (exdScreenConfigurationMesgListeners.end() != it)
    exdScreenConfigurationMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(ExdDataFieldConfigurationMesgListener&
                                      exdDataFieldConfigurationMesgListener) {
  exdDataFieldConfigurationMesgListeners.push_back(
      &exdDataFieldConfigurationMesgListener);
}
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ExdDataFieldConfigurationMesgListener*>::iterator it =
      std::find(exdDataFieldConfigurationMesgListeners.begin(),
                exdDataFieldConfigurationMesgListeners.end(),
                &exdDataFieldConfigurationMesgListener);
  if (exdDataFieldConfigurationMesgListeners.end() != it)
    exdDataFieldConfigurationMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(ExdDataConceptConfigurationMesgListener&
                                      exdDataConceptConfigurationMesgListener) {
  exdDataConceptConfigurationMesgListeners.push_back(
      &exdDataConceptConfigurationMesgListener);
}
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<ExdDataConceptConfigurationMesgListener*>::iterator it =
      std::find(exdDataConceptConfigurationMesgListeners.begin(),
                exdDataConceptConfigurationMesgListeners.end(),
                &exdDataConceptConfigurationMesgListener);
...
void MesgBroadcaster::AddListener(
    DiveSummaryMesgListener& diveSummaryMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<DiveSummaryMesgListener*>::iterator it =
      std::find(diveSummaryMesgListeners.begin(),
                diveSummaryMesgListeners.end(), &diveSummaryMesgListener);
  if (diveSummaryMesgListeners.end() != it) diveSummaryMesgListeners.erase(it);
}
...
void MesgBroadcaster::RemoveListener(HrvMesgListener& hrvMesgListener) {
  std::vector<HrvMesgListener*>::iterator it = std::find(
      hrvMesgListeners.begin(), hrvMesgListeners.end(), &hrvMesgListener);
  if (hrvMesgListeners.end() != it) hrvMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    BeatIntervalsMesgListener& beatIntervalsMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<BeatIntervalsMesgListener*>::iterator it =
      std::find(beatIntervalsMesgListeners.begin(),
                beatIntervalsMesgListeners.end(), &beatIntervalsMesgListener);
  if (beatIntervalsMesgListeners.end() != it)
    beatIntervalsMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    HrvStatusSummaryMesgListener& hrvStatusSummaryMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<HrvStatusSummaryMesgListener*>::iterator it = std::find(
      hrvStatusSummaryMesgListeners.begin(),
      hrvStatusSummaryMesgListeners.end(), &hrvStatusSummaryMesgListener);
...
void MesgBroadcaster::RemoveListener(
    HrvValueMesgListener& hrvValueMesgListener) {
  std::vector<HrvValueMesgListener*>::iterator it =
      std::find(hrvValueMesgListeners.begin(), hrvValueMesgListeners.end(),
                &hrvValueMesgListener);
  if (hrvValueMesgListeners.end() != it) hrvValueMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    RespirationRateMesgListener& respirationRateMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<RespirationRateMesgListener*>::iterator it = std::find(
      respirationRateMesgListeners.begin(), respirationRateMesgListeners.end(),
      &respirationRateMesgListener);
  if (respirationRateMesgListeners.end() != it)
    respirationRateMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    TankUpdateMesgListener& tankUpdateMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<TankUpdateMesgListener*>::iterator it =
      std::find(tankUpdateMesgListeners.begin(), tankUpdateMesgListeners.end(),
                &tankUpdateMesgListener);
  if (tankUpdateMesgListeners.end() != it) tankUpdateMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    TankSummaryMesgListener& tankSummaryMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<TankSummaryMesgListener*>::iterator it =
      std::find(tankSummaryMesgListeners.begin(),
                tankSummaryMesgListeners.end(), &tankSummaryMesgListener);
  if (tankSummaryMesgListeners.end() != it) tankSummaryMesgListeners.erase(it);
}

void MesgBroadcaster::AddListener(
    SleepAssessmentMesgListener& sleepAssessmentMesgListener) {
...
void MesgBroadcaster::RemoveListener(
  ...
  std::vector<SleepAssessmentMesgListener*>::iterator it = std::find(
      sleepAssessmentMesgListeners.begin(), sleepAssessmentMesgListeners.end(),
      &sleepAssessmentMesgListener);
...
void MesgBroadcaster::RemoveListener(PadMesgListener& padMesgListener) {
  std::vector<PadMesgListener*>::iterator it = std::find(
      padMesgListeners.begin(), padMesgListeners.end(), &padMesgListener);
  if (padMesgListeners.end() != it) padMesgListeners.erase(it);
}
  ...
  switch (mesg.GetNum()) {
    ...
    case FIT_MESG_NUM_THREE_D_SENSOR_CALIBRATION: {
      ...
      for (int i = 0; i < (int)threeDSensorCalibrationMesgListeners.size(); i++)
        threeDSensorCalibrationMesgListeners[i]->OnMesg(
    ...
    case FIT_MESG_NUM_ONE_D_SENSOR_CALIBRATION: {
      ...
      for (int i = 0; i < (int)oneDSensorCalibrationMesgListeners.size(); i++)
        oneDSensorCalibrationMesgListeners[i]->OnMesg(
    ...
    case FIT_MESG_NUM_SEGMENT_LEADERBOARD_ENTRY: {
      ...
      for (int i = 0; i < (int)segmentLeaderboardEntryMesgListeners.size(); i++)
        segmentLeaderboardEntryMesgListeners[i]->OnMesg(
    ...
    case FIT_MESG_NUM_EXD_SCREEN_CONFIGURATION: {
      ...
      for (int i = 0; i < (int)exdScreenConfigurationMesgListeners.size(); i++)
        exdScreenConfigurationMesgListeners[i]->OnMesg(
    ...
    case FIT_MESG_NUM_EXD_DATA_FIELD_CONFIGURATION: {
      ...
      for (int i = 0; i < (int)exdDataFieldConfigurationMesgListeners.size();
           i++)
        exdDataFieldConfigurationMesgListeners[i]->OnMesg(
    ...
    case FIT_MESG_NUM_EXD_DATA_CONCEPT_CONFIGURATION: {
      ...
      for (int i = 0; i < (int)exdDataConceptConfigurationMesgListeners.size();
           i++)
        exdDataConceptConfigurationMesgListeners[i]->OnMesg(
