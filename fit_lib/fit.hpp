...
// Non-backwards compatible changes. Decode compatible with this version and
// earlier.
#define FIT_PROTOCOL_VERSION_MAJOR \
  ::fit::versionMap.at(::fit::ProtocolVersion::V20).GetMajorVersion()
// Backwards compatible changes.
#define FIT_PROTOCOL_VERSION_MINOR \
  ::fit::versionMap.at(::fit::ProtocolVersion::V20).GetMinorVersion()
#define FIT_PROTOCOL_VERSION_MAJOR_SHIFT 4
#define FIT_PROTOCOL_VERSION_MAJOR_MASK \
  ((FIT_UINT8)(0x0F << FIT_PROTOCOL_VERSION_MAJOR_SHIFT))
#define FIT_PROTOCOL_VERSION_MINOR_MASK ((FIT_UINT8)0x0F)
#define FIT_PROTOCOL_VERSION \
  ::fit::versionMap.at(::fit::ProtocolVersion::V20).GetVersionByte()
...
#define FIT_PROFILE_VERSION                                             \
  ((FIT_UINT16)(FIT_PROFILE_VERSION_MAJOR * FIT_PROFILE_VERSION_SCALE + \
                FIT_PROFILE_VERSION_MINOR))
...
#define FIT_FLOAT32_INVALID                                        \
  ((FIT_FLOAT32) *                                                 \
   ((FIT_FLOAT32 *)::fit::baseTypeInvalids[FIT_BASE_TYPE_FLOAT32 & \
...
#define FIT_FLOAT64_INVALID                                        \
  ((FIT_FLOAT64) *                                                 \
   ((FIT_FLOAT64 *)::fit::baseTypeInvalids[FIT_BASE_TYPE_FLOAT64 & \
                                           FIT_BASE_TYPE_NUM_MASK]))
...
#define FIT_BYTE_INVALID \
  ((FIT_BYTE)0xFF)  // Field is invalid if all bytes are invalid.
...
typedef struct {
  ...
  FIT_UINT32
  data_size;  // Does not include file header or crc.  Little endian format.
...
#define FIT_MESSAGE_INDEX_FIELD_NUM \
  FIT_FIELD_NUM_MESSAGE_INDEX  // For reverse compatibility only.  Use
                               // FIT_FIELD_NUM_MESSAGE_INDEX instead.
#define FIT_TIMESTAMP_FIELD_NUM \
  FIT_FIELD_NUM_TIMESTAMP  // For reverse compatibility only.  Use
                           // FIT_FIELD_NUM_TIMESTAMP instead.
...
typedef std::wstring
    FIT_WSTRING;  // Returned by message/field "Get" APIs and required by "Set"
                  // APIs. Encoding defined in fit_config.hpp.
