...
class ThreeDSensorCalibrationMesg : public Mesg {
 public:
  ...
  ThreeDSensorCalibrationMesg(void)
      : Mesg(Profile::MESG_THREE_D_SENSOR_CALIBRATION) {}
  ...
  // Comment: Calibration factor used to convert from raw ADC value to degrees,
  // g, etc.
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetCalibrationDivisor(FIT_UINT32 calibrationDivisor) {
    SetFieldUINT32Value(2, calibrationDivisor, 0,
  ...
  void SetOrientationMatrix(FIT_UINT8 index, FIT_FLOAT32 orientationMatrix) {
    SetFieldFLOAT32Value(5, orientationMatrix, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
};
