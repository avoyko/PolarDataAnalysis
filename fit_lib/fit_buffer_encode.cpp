...
BufferEncode::BufferEncode(void) { this->Open(); }
...
void BufferEncode::Write(const Mesg& mesg) {
  ...
  dataSize +=
      mesg.Write(stringWriter, &(lastMesgDefinition[mesg.GetLocalNum()]));
}
...
void BufferEncode::OnMesg(Mesg& mesg) { Write(mesg); }

void BufferEncode::OnMesgDefinition(MesgDefinition& mesgDef) { Write(mesgDef); }
