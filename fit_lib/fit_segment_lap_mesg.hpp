 ...
 public:
  ...
  FIT_BOOL IsTotalStrokesValid() const {
    ...
    if (!CanSupportSubField(
            field,
            (FIT_UINT16)
                Profile::SEGMENT_LAP_MESG_TOTAL_CYCLES_FIELD_TOTAL_STROKES)) {
      return FIT_FALSE;
    }
  ...
  // Set name field
  ///////////////////////////////////////////////////////////////////////
  void SetName(FIT_WSTRING name) { SetFieldSTRINGValue(29, name, 0); }
  ...
  void SetAvgPosVerticalSpeed(FIT_FLOAT32 avgPosVerticalSpeed) {
    SetFieldFLOAT32Value(45, avgPosVerticalSpeed, 0,
  ...
  void SetAvgNegVerticalSpeed(FIT_FLOAT32 avgNegVerticalSpeed) {
    SetFieldFLOAT32Value(46, avgNegVerticalSpeed, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetMaxPosVerticalSpeed(FIT_FLOAT32 maxPosVerticalSpeed) {
    SetFieldFLOAT32Value(47, maxPosVerticalSpeed, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetMaxNegVerticalSpeed(FIT_FLOAT32 maxNegVerticalSpeed) {
    SetFieldFLOAT32Value(48, maxNegVerticalSpeed, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTimeInHrZone(FIT_UINT8 index, FIT_FLOAT32 timeInHrZone) {
    SetFieldFLOAT32Value(49, timeInHrZone, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTimeInSpeedZone(FIT_UINT8 index, FIT_FLOAT32 timeInSpeedZone) {
    SetFieldFLOAT32Value(50, timeInSpeedZone, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTimeInCadenceZone(FIT_UINT8 index, FIT_FLOAT32 timeInCadenceZone) {
    SetFieldFLOAT32Value(51, timeInCadenceZone, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTimeInPowerZone(FIT_UINT8 index, FIT_FLOAT32 timeInPowerZone) {
    SetFieldFLOAT32Value(52, timeInPowerZone, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgLeftTorqueEffectiveness(FIT_FLOAT32 avgLeftTorqueEffectiveness) {
    SetFieldFLOAT32Value(59, avgLeftTorqueEffectiveness, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgRightTorqueEffectiveness(FIT_FLOAT32 avgRightTorqueEffectiveness) {
    SetFieldFLOAT32Value(60, avgRightTorqueEffectiveness, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgLeftPedalSmoothness(FIT_FLOAT32 avgLeftPedalSmoothness) {
    SetFieldFLOAT32Value(61, avgLeftPedalSmoothness, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgRightPedalSmoothness(FIT_FLOAT32 avgRightPedalSmoothness) {
    SetFieldFLOAT32Value(62, avgRightPedalSmoothness, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgCombinedPedalSmoothness(FIT_FLOAT32 avgCombinedPedalSmoothness) {
    SetFieldFLOAT32Value(63, avgCombinedPedalSmoothness, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Set uuid field
  ///////////////////////////////////////////////////////////////////////
  void SetUuid(FIT_WSTRING uuid) { SetFieldSTRINGValue(65, uuid, 0); }
  ...
  void SetAvgFractionalCadence(FIT_FLOAT32 avgFractionalCadence) {
    SetFieldFLOAT32Value(66, avgFractionalCadence, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetMaxFractionalCadence(FIT_FLOAT32 maxFractionalCadence) {
    SetFieldFLOAT32Value(67, maxFractionalCadence, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTotalFractionalCycles(FIT_FLOAT32 totalFractionalCycles) {
    SetFieldFLOAT32Value(68, totalFractionalCycles, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetFrontGearShiftCount(FIT_UINT16 frontGearShiftCount) {
    SetFieldUINT16Value(69, frontGearShiftCount, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetRearGearShiftCount(FIT_UINT16 rearGearShiftCount) {
    SetFieldUINT16Value(70, rearGearShiftCount, 0,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgLeftPowerPhase(FIT_UINT8 index, FIT_FLOAT32 avgLeftPowerPhase) {
    SetFieldFLOAT32Value(75, avgLeftPowerPhase, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgLeftPowerPhasePeak(FIT_UINT8 index,
    ...
    SetFieldFLOAT32Value(76, avgLeftPowerPhasePeak, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgRightPowerPhase(FIT_UINT8 index, FIT_FLOAT32 avgRightPowerPhase) {
    SetFieldFLOAT32Value(77, avgRightPowerPhase, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgRightPowerPhasePeak(FIT_UINT8 index,
    ...
    SetFieldFLOAT32Value(78, avgRightPowerPhasePeak, index,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgPowerPosition(FIT_UINT8 index, FIT_UINT16 avgPowerPosition) {
    SetFieldUINT16Value(79, avgPowerPosition, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetMaxPowerPosition(FIT_UINT8 index, FIT_UINT16 maxPowerPosition) {
    SetFieldUINT16Value(80, maxPowerPosition, index,
                        FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAvgCadencePosition(FIT_UINT8 index, FIT_UINT8 avgCadencePosition) {
    SetFieldUINT8Value(81, avgCadencePosition, index,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetMaxCadencePosition(FIT_UINT8 index, FIT_UINT8 maxCadencePosition) {
    SetFieldUINT8Value(82, maxCadencePosition, index,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTotalFractionalAscent(FIT_FLOAT32 totalFractionalAscent) {
    SetFieldFLOAT32Value(89, totalFractionalAscent, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetTotalFractionalDescent(FIT_FLOAT32 totalFractionalDescent) {
    SetFieldFLOAT32Value(90, totalFractionalDescent, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetEnhancedAvgAltitude(FIT_FLOAT32 enhancedAvgAltitude) {
    SetFieldFLOAT32Value(91, enhancedAvgAltitude, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetEnhancedMaxAltitude(FIT_FLOAT32 enhancedMaxAltitude) {
    SetFieldFLOAT32Value(92, enhancedMaxAltitude, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetEnhancedMinAltitude(FIT_FLOAT32 enhancedMinAltitude) {
    SetFieldFLOAT32Value(93, enhancedMinAltitude, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
};
