...
class GpsMetadataMesg : public Mesg {
 public:
  ...
  // Units: s
  // Comment: Used to correlate UTC to system time if the timestamp of the
  // message is in system time. This UTC time is derived from the GPS data.
  ///////////////////////////////////////////////////////////////////////
  ...
  // Units: m/s
  // Comment: velocity[0] is lon velocity. Velocity[1] is lat velocity.
