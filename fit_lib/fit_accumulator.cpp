...
FIT_UINT32 Accumulator::Accumulate(const FIT_UINT16 mesgNum,
                                   const FIT_UINT8 destFieldNum,
                                   const FIT_UINT32 value,
  ...
  for (i = 0; i < (int)fields.size(); i++) {
    ...
    if ((accumField.mesgNum == mesgNum) &&
        (accumField.destFieldNum == destFieldNum))
      break;
  }
...
void Accumulator::Set(const FIT_UINT16 mesgNum, const FIT_UINT8 destFieldNum,
                      const FIT_UINT32 value) {
  int i;
  AccumulatedField accumField;
