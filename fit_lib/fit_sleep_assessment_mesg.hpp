...
class SleepAssessmentMesg : public Mesg {
 public:
  ...
  // Comment: Average of awake_time_score and awakenings_count_score. If valid:
  // 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  // Comment: Score that evaluates the total time spent awake between sleep. If
  ...
  // Comment: Score that evaluates the number of awakenings that interrupt
  // sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetAwakeningsCountScore(FIT_UINT8 awakeningsCountScore) {
    SetFieldUINT8Value(2, awakeningsCountScore, 0,
  ...
  // Comment: Score that evaluates the amount of deep sleep. If valid: 0 (worst)
  // to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  // Comment: Score that evaluates the quality of sleep based on sleep stages,
  // heart-rate variability and possible awakenings during the night. If valid:
  // 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  // Comment: Score that evaluates the amount of light sleep. If valid: 0
  // (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  // Comment: Total score that summarizes the overall quality of sleep,
  // combining sleep duration and quality. If valid: 0 (worst) to 100 (best). If
  ...
  // Comment: Score that evaluates stress and recovery during sleep. If valid: 0
  // (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  // Comment: Score that evaluates the amount of REM sleep. If valid: 0 (worst)
  // to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  // Comment: Score that evaluates the amount of restlessness during sleep. If
  // valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetSleepRestlessnessScore(FIT_UINT8 sleepRestlessnessScore) {
    SetFieldUINT8Value(10, sleepRestlessnessScore, 0,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  // Comment: Score that evaluates the sleep interruptions. If valid: 0 (worst)
  // to 100 (best). If unknown: FIT_UINT8_INVALID.
  ///////////////////////////////////////////////////////////////////////
  ...
  void SetInterruptionsScore(FIT_UINT8 interruptionsScore) {
    SetFieldUINT8Value(14, interruptionsScore, 0,
                       FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
  ...
  void SetAverageStressDuringSleep(FIT_FLOAT32 averageStressDuringSleep) {
    SetFieldFLOAT32Value(15, averageStressDuringSleep, 0,
                         FIT_SUBFIELD_INDEX_MAIN_FIELD);
  }
};
